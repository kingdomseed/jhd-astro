...
heroAlt: "Ilustração de uma pessoa com um bot amigável"
...
> - O livro Mythic GME 2e para contexto de regras e probabilidades
> - O aplicativo para desktop ou celular instalado

## Antes de começar

 - Uma cópia do livro [Mythic Game Master Emulator 2e](https://www.drivethrurpg.com/en/product/422929/mythic-game-master-emulator-second-edition) (Word Mill Creative) para contexto de regras e orientação
- Seu sistema de RPG favorito e personagem(ns) criados e prontos para jogar
- A versão desktop ou mobile do aplicativo
...
- Desktop: todas as áreas principais são visíveis juntas para que você possa rolar e escrever sem alternar.
...
- Aprenda fórmulas e iniciantes por sistema: “Fórmulas de Dados e Personalização”
- Crie tabelas personalizadas (recurso opcional): “Começando com Tabelas Personalizadas”
- Compartilhe e proteja diários: “Compartilhando Diários de Aventura”
