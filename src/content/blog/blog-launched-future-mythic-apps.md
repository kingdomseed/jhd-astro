...
readTime: 7 minutes
summary: A personal note on the blog, build-in-public development, and the state of the Mythic apps in March 2025.
...
At the time, the next planned update was version 1.6, with Thread Progress Tracks, Keyed Scenes, and potentially custom Lists. There were also planned quality-of-life improvements to lists (thanks again to a community member on Discord for sharing some feedback on the usability and pointing out a couple of mistakes.)

For current requests and app feedback, use the feature request board or head over to Discord to contribute more of your ideas: [Feature Requests](https://feedback.jasonholtdigital.com/board)
